...
class FinalTakeaways(Scene):
    def construct(self):
        ...
        topics = (BulletedList(
            ...
            r"Brief peek into the complexities of mathematical finance",
        ...
        # hack since BulletedList can't properly isolate substrings for coloring
        topics[-1][:len("General problem-solving technique")].set_color(BLUE)
        ...
        self.play(*[FadeOut(x) for x in (header, topics)])
